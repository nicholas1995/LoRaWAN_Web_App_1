      ...
      <v-toolbar-items >
        <v-tooltip bottom>
          <v-icon large slot="activator"
            ...
            @click.stop="$router.push(`/device_profile/create`)" >
            add_box
          </v-icon>
  ...
  data(){
    return {
      headers: [
          ...
          { text: 'Device Profile ID LoRa', value: 'device_profile_id_lora' ,sortable: false},
          { text: 'Device Profile Name', value: 'device_profile_name' , sortable: true },
