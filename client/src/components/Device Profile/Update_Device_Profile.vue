<template>
      ...
      <v-layout align-center justify-center>
        <v-flex xs12 sm8 md12>
            ...
            <v-toolbar light class="primary">
              <v-toolbar-title>Update Device Profile</v-toolbar-title>
            </v-toolbar>
  ...
  <!--Stepper 1--><v-stepper-content step="1">
                    ...
                    <v-btn class="grey lighten-2"
                      @click.stop="update_device_profile()">
...
description_supports_class_c, description_class_c_timeout} from "../../services/functions/form_descriptions_tool_tips.js";
 ...
 created: async function () {
    try {
      if (this.$store.state.loginState == false) {
        ...
        this.device_profile_update = await AuthenticationService.get_device_profile(this.$route.params.device_profile_id_lora)
          ...
          this.mac_version_form = this.device_profile_update.mac_version;
          this.reg_params_revision_form = this.device_profile_update.reg_params_revision;
          this.network_id = this.device_profile_update.network_id;
          this.network_server_id = this.device_profile_update.network_server_id;
          this.max_eirp = this.device_profile_update.max_eirp;
          this.supports_join = this.device_profile_update.supports_join;
          this.rx_delay_1 = this.device_profile_update.rx_delay_1;
          this.rx_dr_offset_1 = this.device_profile_update.rx_dr_offset_1;
          this.rx_dr_2 = this.device_profile_update.rx_dr_2;
          this.rx_frequency_2 = this.device_profile_update.rx_frequency_2;
          this.factory_preset_frequencies = this.device_profile_update.factory_preset_frequencies;
          this.supports_class_b = this.device_profile_update.supports_class_b;
          this.class_b_timeout = this.device_profile_update.class_b_timeout;
          this.ping_slot_period_form = this.device_profile_update.ping_slot_period;
          this.ping_slot_dr = this.device_profile_update.ping_slot_dr;
          this.ping_slot_frequency = this.device_profile_update.ping_slot_frequency;
          this.supports_class_c = this.device_profile_update.supports_class_c;
          this.class_c_timeout = this.device_profile_update.class_c_timeout;
      }else{
        alert('Please login.');
  ...
  computed: {
    device_profile_name_errors(){
      ...
      !this.$v.device_profile_name.alpha_num_dash_space && errors.push('Name must only contain letters, numbers, dashes and spaces')
  ...
  methods: {
    update_device_profile(){
      ...
      || this.$v.class_c_timeout.$invalid){
        ...
        this.class_c_timeout = first_digit_not_0(this.class_c_timeout);


        AuthenticationService.update_device_profiles({
