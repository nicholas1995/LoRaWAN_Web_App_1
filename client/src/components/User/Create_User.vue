...
mixins: [validationMixin],
  ...
  computed: {
    ...
    user_country_errors(){
      ...
      !this.$v.user_country.alpha_space_country && errors.push('Country name must only contain letters, spaces and special characters -,&,_')      
    ...
    user_street_errors(){
      ...
      !this.$v.user_street.alpha_num_space_street && errors.push('Street name must only contain letters, numbers, spaces and special characters -,_,&,#')      
